...
# The manifest storage needs `collectstatic` to have already run (that's
# done as part of the Render build step) - locally/in tests nothing runs
# it, so stick to Django's plain static storage there instead.
if not DEBUG:
    STORAGES = {
        "staticfiles": {
